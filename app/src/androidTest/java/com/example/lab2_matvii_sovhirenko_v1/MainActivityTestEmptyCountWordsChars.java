...
public class MainActivityTestEmptyCountWordsChars {
    ...
    @Test
    public void mainActivityTestEmptyCountWordsChars() {
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.tvResult), withText("Result: The input line is empty!"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView2.check(matches(withText("Result: The input line is empty!")));
    }
